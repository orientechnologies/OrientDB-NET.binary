...
{
    public class GitHub_issue62 : IDisposable
    {
        TestDatabaseContext _context;
        ODatabase _database;
        
        public GitHub_issue62()
        {
        ...
        public void ShouldInsertRetrieveSingleDictionaryProperty()
        {
            ...
            Assert.Equal(createdPerson.EmbededMap["test"], 100);
        }
        ...
        public void AddingModelWithDictionaryOfStringObjectPairToDbAndCheckingStoredData()
        {
            ...
            Assert.Equal(form.FormData["String Test1"], result.FormData["String Test1"]);
            Assert.Equal(form.FormData["String Test2"], result.FormData["String Test2"]);
            ...
            Assert.Equal(form.FormData["Guid Test1"], result.FormData.GetField<Guid>("Guid Test1"));
            Assert.Equal(form.FormData["Guid Test2"], result.FormData.GetField<Guid>("Guid Test2"));
            ...
            Assert.Equal(form.FormData["Number Test1"], result.FormData.GetField<int>("Number Test1"));
            Assert.Equal(form.FormData["Number Test2"], result.FormData.GetField<int>("Number Test2"));
            ...
            Assert.Equal(form.FormData["Bool Test1"], result.FormData.GetField<bool>("Bool Test1"));
            Assert.Equal(form.FormData["Bool Test2"], result.FormData.GetField<bool>("Bool Test2"));
            ...
            Assert.Equal(form.FormData["DateTime Test1"], result.FormData.GetField<DateTime>("DateTime Test1"));
            Assert.Equal(form.FormData["DateTime Test2"], result.FormData.GetField<DateTime>("DateTime Test2"));
        }
